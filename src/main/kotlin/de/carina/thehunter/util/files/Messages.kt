 ...
 * File created on 6/1/22, 4:23 PM by Carina The Latest changes made by Carina on 6/1/22, 4:01 PM All contents of "Messages.kt" are protected by copyright.
...
class Messages(filePath: String) : BaseFile(filePath) {
    ...
    override fun addData(): Messages {
        ...
        yml.addDefault("player-already-in-team", "&cYou are allready in a team!")
        ...
        yml.addDefault("game-arenacenter-set", "&aThe &6arena center&a has been set for game &6%game%&a!")
        ...
        yml.addDefault("bordersize-plus", "&aThe border size has been increased to &6%size%&a for game &6%game%&a!")
        yml.addDefault("bordersize-minus", "&aThe border size has been decreased to &6%size%&a for game &6%game%&a!")
        yml.addDefault("bordersize-to-low", "&cThe border size is to low for game &6%game%&c. Lowest allowed: &6%size%&c!")
        yml.addDefault("bordersize-to-high", "&cThe border size is to for game &6%game%&c. Highest allowed: &6%size%&c!")
        yml.addDefault("save-settings-success", "&aThe settings for game &6%game% &ahave been saved!")
        yml.addDefault("min-players-reduced", "&aThe minimum players has been reduced to &6%players%&a for game &6%game%&a!")
        yml.addDefault("min-players-increased", "&aThe minimum players has been increased to &6%players%&a for game &6%game%&a!")
        yml.addDefault("min-players-to-low", "&cThe minimum players is to low for game &6%game%&c. Lowest allowed: &6%players%&c!")
        yml.addDefault("min-players-to-high", "&cThe minimum players is to high for game &6%game%&c. Highest allowed: &6%players%&c!")
