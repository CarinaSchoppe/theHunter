        ...
        when (args[0].lowercase()) {
            ConstantStrings.CREATE_COMMAND -> {
                if (GamesHandler.games.find { it.name == args[1] } != null) {
                    sender.sendMessage(
                        TheHunter.instance.messages.messagesMap["game-already-exists"]!!.replace(
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-successfully-created"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[1]
                    )
                )
            ...
            ConstantStrings.SELECT_COMMAND -> {
                ...
                if (game == null) {
                    sender.sendMessage(
                        TheHunter.instance.messages.messagesMap[ConstantStrings.GAME_NOT_EXISTS]!!.replace(
                            ConstantStrings.GAME_PERCENT,
                            args[1]
                        )
                    )
            ...
            ConstantStrings.REMOVE_COMMAND -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap[ConstantStrings.COMMAND_NOT_FOUND]!!.replace(
    ...
    private fun removeLocation(args: Array<out String>, sender: CommandSender) {
        ...
        when (args[1].lowercase()) {
            ...
            ConstantStrings.LOBBY_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-lobby-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.SPECTATOR_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-spectator-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.BACK_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-back-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.END_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-end-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.ARENA_CENTER -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-arena-center-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.PLAYER_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-spawn-removed"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
    ...
    private fun configGame(args: Array<out String>, sender: CommandSender) {
        ...
        when (args[1].lowercase()) {
            ConstantStrings.LOBBY_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-lobby-set"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.SPECTATOR_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-spectator-set"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.BACK_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-back-set"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.END_SPAWN -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-end-set"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.ARENA_CENTER -> {
                ...
                sender.sendMessage(
                    TheHunter.instance.messages.messagesMap["game-arena-center-set"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
                    )
                )
            ...
            ConstantStrings.PLAYER_SPAWN -> {
                if (game.playerSpawns.size < game.maxPlayers) {
                    ...
                    TheHunter.instance.messages.messagesMap["game-spawns-to-much"]!!.replace(
                        ConstantStrings.GAME_PERCENT,
                        args[2]
            ...
            ConstantStrings.FINISH_COMMAND -> {
                if (game.isGameInvalidConfigured()) {
                    sender.sendMessage(
                        TheHunter.instance.messages.messagesMap["wrong-config"]!!.replace(
                            ConstantStrings.GAME_PERCENT,
                            args[2]
                        )
                    )
