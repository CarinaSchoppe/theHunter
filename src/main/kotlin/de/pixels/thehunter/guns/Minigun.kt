...
object Minigun : Gun {
    ...
    val minigun = ItemBuilder(Material.STONE_HOE).addDisplayName(TheHunter.prefix + "§7Minigun")
    ...
    private fun shootProjectile(player: Player) {
        ...
        val arrow = player.launchProjectile(
            Arrow::class.java,
            player.location.direction.multiply(GamesHandler.playerInGames[player]!!.gameItems.guns["minigun-power"]!!)
        )
        arrow.damage = 0.0
        ...
        PlayerHotbarHover.updateHotbar(minigun, player)
