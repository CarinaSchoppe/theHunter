...
class Messages(filePath: String) : BaseFile(filePath) {
    ...
    override fun addData(): Messages {
        ...
        yml.addDefault(
            "stats-message-own",
            "&7Your stats: &6%kills% &7Kills, &6%deaths% &7Deaths, &6%kd% &7K/D, &6%wins% &7Wins, &6%losses% &7Losses, &6%points% &7Points, &6%games% &7Games!"
        )
        yml.addDefault(
            "stats-message-other",
            "&7The stats of &6%player% &7: &6%kills% &7Kills, &6%deaths% &7Deaths, &6%kd% &7K/D, &6%wins% &7Wins, &6%losses% &7Losses, &6%points% &7Points, &6%games% &7Games!"
        )
        ...
        yml.addDefault(
            "game-spectator-removed",
            "&cYouve sucessfully removed the spectator spawn for the game &6%game%&c!"
        )
        yml.addDefault("game-spectator-set", "&aThe &6spectator spawn&a has been set for game &6%game%&a!")
        yml.addDefault(
            "game-arena-center-removed",
            "&cYouve sucessfully removed the arena center for the game &6%game%&c!"
        )
        ...
        yml.addDefault(
            "game-spawns-to-much",
            "&cThere are to many gamespawns for game &6%game%&c. Max spawns &6%max%&c!"
        )
        ...
        yml.addDefault(
            "border-size-to-low",
            "&cThe border size is to low for game &6%game%&c. Lowest allowed: &6%size%&c!"
        )
        yml.addDefault(
            "border-size-to-high",
            "&cThe border size is to for game &6%game%&c. Highest allowed: &6%size%&c!"
        )
        yml.addDefault("save-settings-success", "&aThe settings for game &6%game% &ahave been saved!")
        yml.addDefault(
            "min-players-reduced",
            "&aThe minimum player amount has been reduced to &6%players%&a for game &6%game%&a!"
        )
        yml.addDefault(
            "min-players-increased",
            "&aThe minimum player amount has been increased to &6%players%&a for game &6%game%&a!"
        )
        yml.addDefault(
            "min-players-to-low",
            "&cThe minimum player amount is to low for game &6%game%&c. Lowest allowed: &6%players%&c!"
        )
        yml.addDefault(
            "min-players-to-high",
            "&cThe minimum player amount is to high for game &6%game%&c. Highest allowed: &6%players%&c!"
        )
        yml.addDefault(
            "max-players-reduced",
            "&aThe maximum player amount has been reduced to &6%players%&a for game &6%game%&a!"
        )
        yml.addDefault(
            "max-players-increased",
            "&aThe maximum player amount has been increased to &6%players%&a for game &6%game%&a!"
        )
        yml.addDefault(
            "max-players-to-low",
            "&cThe maximum player amount is to low for game &6%game%&c. Lowest allowed: &6%players%&c!"
        )
        yml.addDefault(
            "max-players-to-high",
            "&cThe maximum player amount is to high for game &6%game%&c. Highest allowed: &6%players%&c!"
        )
        ...
        yml.addDefault(
            "teams-size-to-low",
            "&cThe teams size is to low for game &6%game%&c. Lowest allowed: &6%size%&c!"
        )
        yml.addDefault(
            "teams-size-to-high",
            "&cThe teams size is to high for game &6%game%&c. Highest allowed: &6%size%&c!"
        )
